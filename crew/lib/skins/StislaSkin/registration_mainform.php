    ...
    <div class="row">
        <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
                <img src="<?php echo SITE_URL?>/lib/images/reds/the reds logo.png" alt="logo" width="200" class="shadow-light rounded-circle">
            </div>

            <div class="card card-primary">
                <div class="card-header" ><center><h4>Pilot Application Form</h4></center></div>
                    ...
                    <form method="POST" action="<?php echo url('/registration');?>">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <dd>
                                    <input type="hidden" name="code" value="RED" />
                                </dd>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="agree">By ticking the box, I certify that all the datas submitted are valid, and I agree with the terms and conditions</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <input type="submit" name="submit" class="btn btn-primary btn-lg btn-block" value="Apply!" />
                        </div>
                    </form>
                </div>
            </div>
