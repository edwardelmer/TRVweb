    ...
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <?php
                    if(!$pireps) {
                        echo '<div class="alert alert-primary mb-2" role="alert"><strong>No Reports Found!</strong> <br>You have not filed any reports. File one through the RedTrax to see its details and status on this page.</div>';
                    } else {
                ?>
