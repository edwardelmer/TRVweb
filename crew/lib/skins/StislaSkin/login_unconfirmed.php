            ...
            <?php
                if(isset($message))
                    echo '<div class="alert alert-warning">
                        ...
                        Your registration has not yet been validated by our staff. Please try again later. You will receive an email when your registration has been accepted.</div>';
            ?>
