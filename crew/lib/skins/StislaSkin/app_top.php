        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <img src="<?php echo SITE_URL?>/lib/images/reds/the reds logo.png" alt="logo" width="150" >
                </div>

                <div class="sidebar-brand sidebar-brand-sm">
                    <img src="<?php echo SITE_URL?>/lib/images/reds/Logo Round L.png" alt="logo" width="40" >
                </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a class="nav-link" href="<?php echo url('/exams'); ?>">
                            <i class="fas fa-user-graduate"></i> <span><font color="#ff000"><strong>RED</strong></font>Academy</span>
                        </a>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-trophy"></i> <span>Leaderboard</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="<?php echo url('/TopPilot'); ?>"> <span>Top Pilots</span></a></li>
                            <li><a class="nav-link" href="<?php echo url('/Touchdownstats'); ?>"> <span>Landing Statistic</span></a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="nav-link" href="<?php echo url('/AutoAssign') ?>">
                        <i class="fas fa-plane-departure"></i> <span>Flight Assignment</span>
                        </a>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-calendar-alt"></i> <span>Tours & Events</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="<?php echo url('/tour'); ?>"></i> <span>Tours</span></a></li>
                            <li><a class="nav-link" href="<?php echo url('/events'); ?>"></i> <span>Events</span></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-university"></i> <span>Company</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="<?php echo url('/pages/about'); ?>"> <span>About</span></a></li>
                            <li><a class="nav-link" href="<?php echo url('/vStaff'); ?>"> <span>Staff</span></a></li>
                            <li><a class="nav-link" href="<?php echo url('/Circulars'); ?>"> <span>Circulars</span></a></li>
                            <li><a class="nav-link" href="<?php echo url('/Ruleregs'); ?>"> <span>Rules & Regulations</span></a></li>
                            <li><a class="nav-link" href="<?php echo url('/credits'); ?>"> <span>Credits</span></a></li>
                        </ul>
                    </li>
                    <li>
