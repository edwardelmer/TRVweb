    ...
    <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
                ...
                <!-- <img src="<?php echo SITE_URL?>/lib/images/reds/the reds logo.png" alt="logo" width="300" class="shadow-light rounded-circle"> -->
            </div>
            ...
            <div class="mt-5 text-muted text-center">
                You dont work here? <a href="<?php echo SITE_URL?>/index.php/RuleRegss">Apply now</a>
            </div>
