 ...
 * https://code.google.com/apis/maps/documentation/v3/reference.html#MapTypeId
 * 
...
<script src="//crew.theredsvirtual.com/lib/js/base_map.js"></script>
<script src="//crew.theredsvirtual.com/lib/js/acarsmap.js"></script>
<?php
...
<tr class="<%=flight.trclass%>" align="center">
    <th scope="col"><a href="<?php echo url('/profile/view');?>/<%=flight.pilotid%>"><%=flight.pilotid%></a></th>
