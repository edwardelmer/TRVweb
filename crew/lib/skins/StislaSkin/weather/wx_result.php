						...
						<div class="card">
							<div class="card-body">
								<div class="card-contact">
									...
									<div class="contact-item">
										<h6>Elevation</h6>
										<span class="float-right align-right"><?php echo $station['data'][0]['elevation']['feet']; ?> ft/<?php echo $station['data'][0]['elevation']['meters']; ?> mtr</span>
									</div>
									<div class="contact-item">
										<h6>Facility</h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="card-contact">
									...
									<div class="contact-item">
										<h6>GMT Offset</h6>
										<span class="float-right align-right"><?php echo $station['data'][0]['timezone']['gmt']; ?> hours</span>
									</div>
									<div class="contact-item">
										<h6>Current Time</h6>
							...
							<div class="card-body">
								...
								<div class="card-contact">
									...
									<div class="contact-item">
										<h6>Pressure</h6>
										<span class="float-right align-right">
											<?php echo $metar['data'][0]['barometer']['hpa'].' hPa'; ?>
										</span>
									</div>
