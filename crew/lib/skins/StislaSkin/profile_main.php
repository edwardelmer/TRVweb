    ...
    <div class="row mt-sm-4">
        <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget">
                ...
                <div class="text-center">
                        <div class="profile-widget-item-label"><a href="<?php echo SITE_URL; ?>/lib/signatures/<?php echo $pilotCode;?>.png" download="<?php echo $pilotCode;?>.png">
                          <img height="125" src="<?php echo SITE_URL; ?>/lib/signatures/<?php echo $pilotCode;?>.png" class="img-fluid" alt="Badge">
                        </a></div>
                        <div class="profile-widget-item-value">
                            Right click to save your badge <br>
                            Forum BB Code : <br>
                            [url=https://theredsvirtual.com][img src=<?php echo SITE_URL; ?>/lib/signatures/<?php echo $pilotCode;?>.png][/url]
                        </div>
                    </div>
            </div>
