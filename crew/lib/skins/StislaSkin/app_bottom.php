                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel1">LogBook of <?php echo Auth::$userinfo->firstname.' '.Auth::$userinfo->lastname; ?></h5>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo number_format($report->flighttime, 2, ':',''); ?></td>
        ...
        <footer class="main-footer">
            <!--
            <div class="footer-left">Copyright &copy; <?php echo date("Y"); ?> <a href="https://getstisla.com/">Muhamad Nauval Azhar</a></div> 
            -->
            <div class="footer-right" align="right">CrewCenter by <a href="https://www.instagram.com/carlosmeduardo/">Carlos Eduardo </a>ReDesign By <?php echo SITE_NAME; ?> Copyright &copy; <?php echo date("Y"); ?><br />Powered by phpVMS</div>
            <div class="footer-left"><td align="right">
