							...
							<tr>
								...
								<td colspan="6" id="details_<?php echo $route->flightnum; ?>" style="display: none;" width="100%">
									<table class="table table-striped">
										<tr>
											<th align="center" bgcolor="black" colspan="6"><font color="white">Flight Details</font></th>
										</tr>
										<tr>
											<td>Departure:</td>
											<td colspan="2"><strong>
										...
										<tr>
											<td>Dep Time:</td>
											<td colspan="2"><strong><font color="red"><?php echo $route->deptime?> </font></strong></td>
											<td>Arr Time:</td>
											<td colspan="2"><strong><font color="red"><?php echo $route->arrtime?> </font></strong></td>
										</tr>
										<tr>
											<td>Altitude:</td>
										...
										<tr>
											...
											?>
											<img width="100%" src="https://www.gcmap.com/map?P=<?php echo $string ?>&amp;MS=bm&amp;MR=240&amp;MX=680x200&amp;PM=pemr:diamond7:red%2b%22%25I%22:red&amp;PC=%230000ff" />
										</tr>-->
									</table>
								</td>
								<?php } ?>
