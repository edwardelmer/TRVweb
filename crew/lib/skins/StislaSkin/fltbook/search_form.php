                ...
                <form action="<?php echo url('/Fltbook');?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="aircraft">
                            ...
                            <?php
                            	 if(Auth::$userinfo->rankid == 1 )
                            		{
                            		   echo '<option>No Aircraft Selection!</option>';
                            		} else{
                            					if($settings['search_from_current_location'] == 1) {
                            					    ...
                            					    if(!$airc) {
                            					        ...
                            					        foreach ($airc as $air) {
                            					            ...
                            					            echo '<option value="'.$ai->icao.'">'.$ai->registration.'</option>';
                            					        }
                            					    }
                            					} else {
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo url('/Fltbook/jumpseat');?>" method="post">
                    ...
                    <input type="submit" id="purchase_button" class="btn btn-primary mr-1" style="float: right;" value="Purchase Transfer">
