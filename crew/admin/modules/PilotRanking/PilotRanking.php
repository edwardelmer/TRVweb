...
class PilotRanking extends CodonModule {
	...
	protected function add_rank_post() {
		...
		$ret = RanksData::AddRank($this->post->rank, $this->post->minhours, $this->post->imageurl, $this->post->payrate, $this->post->eksam);
	...
	protected function edit_rank_post() {
		...
		$ret = RanksData::UpdateRank($this->post->rankid, $this->post->rank, $this->post->minhours, $this->post->rankimage, $this->post->payrate, $this->post->eksam);
