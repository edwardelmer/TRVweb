...
*/
?>
<h3 align="center">Issues Tasks</h3>
<ul class="filetree treeview-famfamfam">
	<li><span class="file">
    	<a href="<?php echo SITE_URL?>/admin/index.php/vStaffListAdmin">The Reds Staff List</a>
	</span></li>
	
</ul>
<h3></h3>
<p><center>vStaffList Module Made By Vansers Add-Ons &copy; 2013</center></p>