...
<tr id="row<?php echo $issue->grt_id;?>">
	<td align="left"><?php echo $pilotcode.' '.$issue->firstname.' '.$issue->lastname;?></td>
    <td align="left"><?php echo $issue->typ_name.' - '.$issue->awd_name;?></td>
    <td align="left"><?php echo date(DATE_FORMAT, $issue->grt_dategrant);?></td>
