...
?>
<p>There are a total of <?php echo count($pireps);?> unchecked reports in this category. <a href="<?php echo SITE_URL?>/admin/index.php/pirepadmin/approveall">Click to approve all</a></p>
<?php
...
<tr>
    <td style="border: none;" align="left">
    	...
    	<!-- <button class="jqModal {button:{icons:{primary:'ui-icon-script'}}}" id="dialog_details" 
    	    href="<?php echo SITE_URL?>/admin/action.php/pirepadmin/viewlog?pirepid=<?php echo $pirep->pirepid;?>">Flight Log</button> -->
    	    
    	<button class="jqModal {button:{icons:{primary:'ui-icon-script'}}}" id="dialog_details" 
    	    href="#" onclick="$('#log_<?php echo $pirep->pirepid;?>').toggle(); ">Flight Log</button>
    	    
    	 <button class="jqModal {button:{icons:{primary:'ui-icon-script'}}}" id="dialog_details" 
    	    href="#" onclick="$('#comments').toggle(); return false;">Comments <span style="font-size: 12px; margin-top: -3px">(<?php echo PIREPData::getCommentCount($pirep->pirepid); ?>)</span></button>
...
?>
    ...
    <div id="log_<?php echo $pirep->pirepid;?>" 
    style="display: none; overflow: auto; height: 400px; border: 1px solid #666; margin-bottom: 20px; padding: 5px; padding-top: 0px; padding-bottom: 20px;">
    <?php
