...
<div id="pireplist">
		...
		<tbody>
			...
			<tr class="<?php echo $class?> pirep_list" id="row<?php echo $pirep->pirepid;?>">
				...
				<td align="left" valign="top" nowrap class="<?php echo $td_class;?>">
					...
					<table width="100%" style="border: none;">
						<tr>
							<td style="border: none;" align="left">
								...
								<button class="jqModal {button:{icons:{primary:'ui-icon-script'}}}" id="dialog_details" 
                        	        href="#" onclick="$('#comments_<?php echo $pirep->pirepid;?>').toggle();">Comments <span style="font-size: 12px; margin-top: -3px">(<?php echo PIREPData::getCommentCount($pirep->pirepid); ?>)</span></button>
					...
					<br />
					<div id="comments_<?php echo $pirep->pirepid;?>" 
						style="display: none; overflow: auto; height: 400px; border: 1px solid #666; margin-bottom: 20px; padding: 5px; padding-top: 0px; padding-bottom: 20px;">
						<?php
						$comments = array();
						if(!$comments)
	...
	<br />
		...
		?>
			<div style="float: right;">
			<a href="?admin=<?php echo $admin?>&start=<?php echo $start?>">More Pireps</a>
			<br />
			</div>
			<?php
