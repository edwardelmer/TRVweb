...
<table width="98%" align="center" cellpadding="4">
	...
	<tr>
		<td width="50%" ><div id="<?php echo $schedule->depicao; ?>" class="metar">Getting Airport METAR</div> <br />
			<a href="https://flightaware.com/resources/airport/<?php echo $schedule->depicao?>/weather" target="_blank">
			View Weather Details</a>
		</td>
		<td width="50%" ><div id="<?php echo $schedule->arricao; ?>" class="metar">Getting Airport METAR</div><br />
			<a href="https://flightaware.com/resources/airport/<?php echo $schedule->arricao?>/weather" target="_blank">
...
<tr>
	<td><a href="https://flightaware.com/analysis/route.rvt?origin=<?php echo $schedule->depicao?>&destination=<?php echo $schedule->arricao?>">View recent IFR Routes data</a></td>
</tr>
</table>
...
<table width="98%" align="center">
	...
	<tr align="center">
		<td width="50%" valign="top">
			<a href="https://www.airnav.com/airport/<?php echo $schedule->depicao?>#ifr" target="_blank">
			<img border="0" src="https://flightaware.com/resources/airport/<?php echo $schedule->depicao?>/APD/AIRPORT+DIAGRAM/png"
				width="387px" height="594px" alt="No chart available" /></a>
		</td>
		<td width="50%" valign="top">
			<a href="https://www.airnav.com/airport/<?php echo $schedule->arricao?>#ifr" target="_blank">
			<img border="0" src="https://flightaware.com/resources/airport/<?php echo $schedule->arricao?>/APD/AIRPORT+DIAGRAM/png" 
				width="387px" height="594px" alt="No chart available" /></a>
		</td>
...
<h3>Weather</h3>
<div align="center">
	<p><img src="https://flightaware.com/resources/wx/us_depiction.gif" /></p>
	<p><img src="https://flightaware.com/resources/wx/surface_analysis.gif" /></p>
	<p><img src="https://flightaware.com/resources/wx/national_radar.gif" /></p>
	<p><img src="https://flightaware.com/resources/wx/us_high_level_weather_12z.gif" /></p>
	<p><img src="https://flightaware.com/resources/wx/severe_outlook_day_1.gif" /></p>
	<a href="https://flightaware.com/resources/weather_maps/" target="_blank">View additional weather graphs</a>
</div>
<div align="right" style="font-size: small;">Data Courtesy of <a href="https://flightaware.com" target="_new">FlightAware</a></div>
<br />