...
class Exams extends CodonModule {
    ...
    public function grade_exam() 
	{
        ...
        if ($result >= $passing) {
            echo '<div class="card">';
            echo '  <tr align="center"><br /><h5>Congratulation!</h5></tr>';
            echo '  <tr align="center"><h6>You answered '.$correct.' questions correctly out of '.$howmany.' total in this '.$exam_description.'.</h6></tr>';
            echo '  <tr align="center"><h6><br />Your overall score is <font color="#FF0000"><b>'.$result.'</font></b>.</h6></tr>';
            echo '  <tr><br />Our staff will upgrade your pilot rank accordingly.</tr>';
            echo '</div>';
        }
        else {
            echo '<div class="card">';
            echo '  <tr align="center"><br /><h5>Try Again!</h5></tr>';
            echo '  <tr align="center"><h6>You only answered '.$correct.' questions correctly out of '.$howmany.' total in this '.$exam_description.'.</h6></tr>';
            echo '  <tr align="center"><h6><br />Minimum score of '.$passing.'% is needed to pass this exam.</h6></tr>';
            echo '</div>';
        }
        echo '</div>';
        echo '</table><br />';
        echo '<form method="link" action="'.SITE_URL.'/index.php/Exams/view_profile">';
        echo '<input type="submit" class="btn btn-icon icon-left btn-primary btn-round" value="Return To Your Exam History"></form>';
    }
