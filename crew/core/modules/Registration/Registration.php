...
class Registration extends CodonModule
{
	public function HTMLHead() {
		...
		if($this->get->page == 'register') {
			$this->renderTemplate('registration_javascript.php');
		}
	}
	...
	protected function ShowForm()
	{
		...
		$this->render('registration_mainform.php');
	}
	...
	protected function ProcessRegistration()
	{
		...
		$message = Template::Get('email_registered.php', true);
