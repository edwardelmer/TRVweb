...
class Schedules extends CodonModule {
    ...
    public function details($routeid = '') {
        ...
        $this->render('schedule_details.php');
    ...
    public function boardingpass($routeid) {
        ...
        $this->set('schedule', $schedule);
        $this->render('schedule_boarding_pass.php');
    }
    ...
    public function showSchedules() {
        ...
        $this->render('schedule_searchform.php');
    ...
    public function findFlight() {
        ...
        $this->render('schedule_results.php');
    }
