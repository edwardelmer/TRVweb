...
class Login extends CodonModule
{
	...
	public function logout()
	{
		...
		$this->render('login_complete.php');
	}
	...
	public function forgotpassword()
	{
		...
		$this->render('login_forgotpassword.php');
	}
	...
	public function ResetPassword()
	{
		...
		if(!$email) {
			...
			if(!$pilot) {
				$this->render('login_notfound.php');
				return;
			}
			...
			$message = Template::GetTemplate('email_lostpassword.php', true);
			
			Util::SendEmail($pilot->email, 'Password Reset', $message);
			
			$this->render('login_passwordreset.php');
		}
	}
	...
	public function ProcessLogin()
	{
		...
		if(!Auth::ProcessLogin($email, $password))
		{
			...
			if(Auth::$pilot->confirmed == PILOT_PENDING) {
				$this->render('login_unconfirmed.php');
				Auth::LogOut();
				
				// show error
			} elseif(Auth::$pilot->confirmed == PILOT_REJECTED) {
				$this->render('login_rejected.php');
				Auth::LogOut();
			} else {
