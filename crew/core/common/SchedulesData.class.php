...
class SchedulesData extends CodonData {
     ...
     * Using a revised equation found on https://www.movable-type.co.uk/scripts/latlong.html
     * 
    ...
    public static function distanceBetweenPoints($lat1, $lng1, $lat2, $lng2) {
        ...
        New formula, from https://jan.ucc.nau.edu/~cvm/latlon_formula.html
        */
...
#        $data['flighttime'] = str_replace(':', '.', $data['flighttime']);
        $data['flighttime'] = str_replace('.', ':', is_float($data['flighttime']) ? $data['flighttime'] : $data['flighttime'] . ':00');

        /* Proper timestamp
        
        $data['flighttime'] = str_replace(':', '.', $data['flighttime']);
        $data['flighttime_stamp'] = str_replace('.', ':', $data['flighttime']).':00'; */
