...
class PIREPData extends CodonData {
     ...
     *
     * @tutorial https://docs.phpvms.net/media/development/searching_and_retriving_schedules
     */
        ...
        if ($row) {
            ...
            if ($row->source == 'fsfk') {
                ...
                if (isset($data['FLIGHTDATA'])) {
                    ...
                    $flightdata = Template::Get('fsfk_log_flightdata.php', true, true, true);
                    $row->log .= $flightdata;
                    unset($flightdata);
                }
                ...
                if (isset($data['FLIGHTPLAN'])) {
                    ...
                    $flightplan = Template::Get('fsfk_log_flightplan.php', true, true, true);
                ...
                if (isset($data['FLIGHTCRITIQUE'])) {
                    ...
                    $critique = Template::Get('fsfk_log_flightcritique.php', true, true, true);
                ...
                if (isset($data['FLIGHTMAPS'])) {
                    ...
                    $flightimages = Template::Get('fsfk_log_flightimages.php', true, true, true);
...
#            $pirepdata['route'] = str_replace('DCT', '', $pirepdata['route']);
        ...
        /*$pirepdata['flighttime'] = str_replace('.', ':', is_float($pirepdata['flighttime']) ? $pirepdata['flighttime'] : $pirepdata['flighttime'] . ':00');*/
