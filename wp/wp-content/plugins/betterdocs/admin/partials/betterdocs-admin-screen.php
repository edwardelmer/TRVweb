                ...
                <div class="betterdocs-header-full">
                    <div class="betterdocs-header-filter">
                        ...
                        <form id="posts-filter" method="get" action="<?php echo $form_action; ?>">
                            ...
                            <input id="reportrange" class="dashboard-select-date-custom" type="text" name="date_range" title="<?php echo (isset($_GET['date_range'])) ? $_GET['date_range'] : ''; ?>" value="<?php echo (isset($_GET['date_range'])) ? esc_attr($_GET['date_range']) : ''; ?>" />
